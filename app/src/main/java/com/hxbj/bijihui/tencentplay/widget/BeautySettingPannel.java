...
import com.hxbj.bijihui.tencentplay.editor.TCHorizontalScrollView;
    ...
    private void initView(View view) {
        ...
        rlyt_beauty.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ctv_lvjing.setTextColor(getResources().getColor(R.color.colorTextWhite));
        ...
        rlyt_lvjing.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ctv_beauty.setTextColor(getResources().getColor(R.color.colorTextWhite));
            }
        });
