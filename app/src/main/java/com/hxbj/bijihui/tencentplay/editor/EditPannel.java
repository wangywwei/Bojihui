package com.hxbj.bijihui.tencentplay.editor;
    ...
    private void init(Context context) {
        ...
        mCutBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                mCutLL.setVisibility(VISIBLE);
                mFilterLL.setVisibility(GONE);
                mCutBtn.setImageResource(R.drawable.dp_cut_on);
                mFilterBtn.setImageResource(R.drawable.dp_lvjing_of);
            }
        });
        mFilterBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mCutBtn.setImageResource(R.drawable.dp_cut_off);
                mFilterBtn.setImageResource(R.drawable.dp_lvjing_off);
            }
        });
