...
import com.hxbj.bijihui.tencentplay.choose.TCVideoEditerMgr;
import com.hxbj.bijihui.tencentplay.choose.TCVideoFileInfo;
import com.hxbj.bijihui.tencentplay.utils.TCConstants;
import com.hxbj.bijihui.tencentplay.widget.BeautySettingPannel;
import com.hxbj.bijihui.tencentplay.widget.TCAudioControl;
import com.hxbj.bijihui.utils.AppManager;
...
//        getSupportActionBar().hide();//隐藏掉整个ActionBar，包括下面的Tabs
        ...
        rlyt_close=findViewById(R.id.rlyt_close);
        flash_button=findViewById(R.id.flash_button);
        switch_camera_button=findViewById(R.id.switch_camera_button);
        beaut_button=findViewById(R.id.beaut_button);
        next_done=findViewById(R.id.next_done);
        record_delete=findViewById(R.id.record_delete);
        btn_pause=findViewById(R.id.record);
        llyt_beauty_pannel=findViewById(R.id.llyt_beauty_pannel);
    }
