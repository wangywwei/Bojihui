package com.hxbj.bijihui.tencentplay.choose;
...
public class TCVideoEditerMgr {
    ...
    public ArrayList<TCVideoFileInfo> getVideo(String fileName) {
        ArrayList<TCVideoFileInfo> videos = new ArrayList<TCVideoFileInfo>();
        String[] mediaColumns = new String[]{
                MediaStore.Video.VideoColumns._ID,
                MediaStore.Video.VideoColumns.DATA,
        ...
        if (cursor.moveToFirst()) {
            do {
                String fname = cursor.getString(cursor.getColumnIndexOrThrow(MediaStore.Video.Media.DISPLAY_NAME));
