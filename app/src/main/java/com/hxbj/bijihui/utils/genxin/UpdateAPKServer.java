package com.hxbj.bijihui.utils.genxin;
...
import com.hxbj.bijihui.LodingActivity;
...
public class UpdateAPKServer extends Service {
	...
	private Handler updateHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case DOWNLOAD_COMPLETE:
				...
				File updateFile = new File(StringStatic.DIR_UPDATE_APK, getApplicationContext()
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		if (android.os.Environment.MEDIA_MOUNTED.equals(android.os.Environment
			...
			m_FileSaveDir = new File(StringStatic.DIR_UPDATE_APK);
		...
		// 设置点击通知栏跳转到主界面
		m_UpdateIntent = new Intent(this, LodingActivity.class);
